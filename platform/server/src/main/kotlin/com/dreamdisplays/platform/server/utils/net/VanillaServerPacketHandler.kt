...
/**
 * Vanilla Minecraft API packet actions, shared between the frozen v1 receivers registered here and
 * the protocol-v2 dispatch in [VanillaV2Networking]-style handlers. All business logic is shared by
 * `Fabric` and `NeoForge`; only the two [registerReceivers] overloads are loader-specific, since
 * Fabric's and NeoForge's payload-registration APIs are unrelated.
 */
